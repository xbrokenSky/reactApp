...
const ErrorHandler = () => {
    return (
        <section className='error-handler'>
            <svg className='error-handler__icon' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 64 64'>
                <defs>
                    <linearGradient y2='161.29' x2='0' y1='218.22' gradientUnits='userSpaceOnUse' id='error-gradient'>
                        <stop stopColor='#c52828' />
                        <stop offset='1' stopColor='#ff5454' />
                    </linearGradient>
                </defs>
                <g transform='matrix(.92857 0 0 .92857-666.94-144.37)'>
                    <circle r='28' cy='189.93' cx='752.7' fill='url(#error-gradient)' />
            ...
            <h1 className='error-handler__txt'>
                Error uccured :(
            </h1>
        </section>
    );
